        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-body">
                    ...
                    <form action="<?php echo site_url();?>category/save" method="POST" class="edit-category" id="edit-category">

                        <input type="hidden" class="form-control" id="category_id" name="category_id" value="<?php echo $category['category_id']; ?>">
